...
urlpatterns = [
    ...
    # 1er cycle fondamental — annee_pk remplace periode_pk (compositions /10)
    path('bulletin-composition/<int:eleve_pk>/<int:annee_pk>/<int:numero>/', views_notes.bulletin_composition, name='bulletin_composition'),
