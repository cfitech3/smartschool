...
urlpatterns = [
    ...
    path('utilisateurs/espionnage/<int:user_pk>/', views_comptes.se_connecter_comme, name='se_connecter_comme'),
    path('utilisateurs/quitter-espionnage/', views_comptes.quitter_espionnage, name='quitter_espionnage'),
